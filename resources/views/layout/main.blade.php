        ...
        <nav class="border-b border-gray-800">
            <div class="container mx-auto px-4 flex flex-col md:flex-row items-center justify-between px-4 py-6">
                ...
                <div class="flex items-center">
                    <div class="relative">
                        <input type="text" class="bg-gray-800 rounded-full w-54 px-4 pl-8 py-1 focus:outline-noce focus:shadow-outline"
                            placeholder="Search"
                        />
                        <div class="absolute top-0">
                            <svg class="fill-current w-4 text-gray-500 mt-2 ml-1 text-sm" viewBox="0 0 24 24"><path class="heroicon-ui"
                    ...
                    <div class="ml-4">
                        <a href="#">
                            <img src="https://d3njjcbhbojbot.cloudfront.net/api/utilities/v1/imageproxy/https://coursera-instructor-photos.s3.amazonaws.com/54/07feb0aaa611e3a9365b00b1f798a2/photo_large.jpg?auto=format%2Ccompress&dpr=1&w=200&h=200" alt="avatar" class="rounded-full w-8 h-8 "/>
                        </a>
                    </div>
                </div>
            </div>
